...
Priporočena je uporaba pgfplots 1.18 (`\pgfplotsset{compat=1.18}`)
...
V prihajajočih verzijah:
- fill-between grafi,
- histogrami+ (err, ecolor, log, horizontalni),
- možnost avtomatskega redčenja in filtriranja podatkov na vidno območje (optimizacija kompilacije v LaTeX-u),
- ...
  
Nekatere priljubljene, a nepodprte nastavitve:
- 3D grafi,
- barvne sheme,
- ...
